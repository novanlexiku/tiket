...
<div class="container-fluid mt--7">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
						<thead class="thead-light">
							<tr>
								<th scope="col" style="text-align:center;width:40px;">No</th>
								<th scope="col">Kendaraan Tiket Seri</th>
						...
						<tbody>
							...
							?>
								<tr>
									<td style="text-align:center;"><?php echo $no; ?></td>
									<td><?php echo $kenser; ?></td>
									<td><?php echo $tanggal; ?></td>
									<td><?php echo $kepen; ?></td>
									<td style="text-align:center;">
										<a class="btn btn-success btn-sm" href="#modalPenumpang<?php echo $kenid ?>" data-toggle="modal" title="Pesan"><span class="ni ni-fat-add"></span>Tambahkan Penumpang</a>
										<a class="btn btn-info btn-sm" href="#modalPenumpang2<?php echo $kenid ?>" data-toggle="modal" title="Pesan"><span class="ni ni-fat-add"></span>Tampil Data Penumpang</a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
	...
	foreach ($p_kendaraan->result_array() as $a) {
		...
		$kepen = $a['kendaraan_nama_pengemudi'];
	?>
		<div id="modalPenumpang<?php echo $kenid ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
					...
					<form class="form-horizontal" method="post" action="<?php echo base_url() . 'index.php/admin/p_kendaraan/tambah_penumpang' ?>">
						<div class="modal-body">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="form-control-label" for="input-nama">Nama Penumpang</label>
										<input name="nama" class="form-control" type="text" placeholder="Masukkan Nama" required>
									</div>
								</div>
							</div>
	...
	foreach ($p_kendaraan->result_array() as $a) {
		...
		$tanggal = $a['tanggal'];
		$kepen = $a['kendaraan_nama_pengemudi'];
		$kenkmp = $a['kendaraan_kmp'];
	?>
		<div id="modalPenumpang2<?php echo $kenid ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
