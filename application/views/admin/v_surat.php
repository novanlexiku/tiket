	...
	<div class="row mt-5">
        ...
        <div class="modal fade" id="surat_perlintasan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/admin/surat/surat_jalan'?>" target="_blank">
                            ...
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
								...
								<div class="row">
									<div class="col-md-12">
									<div class="form-group">
										<label class="form-control-label" for="input-nama">Nama Petugas</label>
										<input name="nama_petugas" class="form-control" type="text" placeholder="Masukkan Nama" required>
									</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
									<div class="form-group">
										<label class="form-control-label" for="input-nama">Nama Nahkoda</label>
										<input name="nama_nahkoda" class="form-control" type="text" placeholder="Masukkan Nama" required>
									</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
									<div class="form-group">
										<label class="form-control-label" for="input-nama">Nama Manager</label>
										<input name="nama_manager" class="form-control" type="text" placeholder="Masukkan Nama" required>
									</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
									<div class="form-group">
										<label class="form-control-label" for="input-nama">Nama Syahbandar</label>
										<input name="nama_syahbandar" class="form-control" type="text" placeholder="Masukkan Nama" required>
									</div>
									</div>
								</div>
