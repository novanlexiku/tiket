...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN PENUMPANG LINTASAN : <?php echo $b['lintasan_nama'];?></h4></center><br/></td>
</tr>
<tr>
...
?>
    <tr>
        ...
        <td style="text-align:left;"><?php echo $kmp;?></td>
		<td style="text-align:left;"><?php echo $lin;?></td>
